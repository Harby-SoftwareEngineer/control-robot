...
import 'package:robot/widigts/fourbutton.dart';
import 'package:robot/widigts/screen.dart';
...
class _HomePageState extends State<HomePage> {
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isScreenOn ? Colors.red : Colors.green,
  ...
  void _sendUpMessageToBluetooth() async {
    connection?.output.add(Uint8List(0));
    await connection?.output.allSent;
